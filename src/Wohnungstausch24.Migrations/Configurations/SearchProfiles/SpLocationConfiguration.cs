...
{
    public class SpLocationConfiguration:CustomEntityTypeConfiguration<SpLocation>
    {
        public SpLocationConfiguration()
        {
            ToTable(nameof(SpLocation), Constants.SearchProfileSchemaName);
        }
    }
}