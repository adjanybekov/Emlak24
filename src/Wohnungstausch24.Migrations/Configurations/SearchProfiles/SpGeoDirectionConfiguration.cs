...
{
    public class SpGeoDirectionConfiguration:CustomEntityTypeConfiguration<SpGeoDirection>
    {
        public SpGeoDirectionConfiguration()
        {
            ToTable(nameof(SpGeoDirection), Constants.SearchProfileSchemaName);
        }
    }
}