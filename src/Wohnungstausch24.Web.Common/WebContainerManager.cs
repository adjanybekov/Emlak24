...
namespace Wohnungstausch24.Web.Common
{
    public static class WebContainerManager
    {
        ...
        public static T Get<T>()
        {
            ...
            if (service == null)
                throw new NullReferenceException(
                    string.Format("Requested service of type {0}, but null was found.", typeof(T).FullName));
            return (T)service;
        }
        ...
        public static IEnumerable<T> GetAll<T>()
        {
            ...
            if (!services.Any())
                throw new NullReferenceException(
                    string.Format("Requested services of type {0}, but none were found.", typeof(T).FullName));
