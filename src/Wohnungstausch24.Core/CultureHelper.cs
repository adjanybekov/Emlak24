...
namespace Wohnungstausch24.Core
{
    public static class CultureHelper
    {
        ...
        private static readonly List<string> _cultures = new List<string> {"en","de"};
        private static readonly List<string> _agentCultures = new List<string> {"en","de","tr","ar","fr","it"};
        /// <summary>
        ...
        {
            return WebConfigurationManager.AppSettings["DefaultUiCulture"]; // return Default culture
        }
        public static string GetCurrentCulture()
        {
            return Thread.CurrentThread.CurrentCulture.Name;
        }
        public static CultureInfo GetCurrentCultureObject()
        {
        ...
        {
            return _cultures.Select(c => new CultureInfo(c));
        }
        public static IEnumerable<CultureInfo> GetAvailableAgentCultures()
        {
            return _agentCultures.Select(c => new CultureInfo(c));
        }
    }
}
