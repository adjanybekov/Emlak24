...
{
    public class Step9ViewModelToListings : IAutoMapperTypeConfigurator
    {
        public void Configure(IMapperConfigurationExpression cfg)
        {
            cfg.CreateMap<Step9FlatForRent, FlatForRent>()
            ...
            cfg.CreateMap<Step9RoomForRent, RoomForRent>()
                .ForMember(c => c.HasAirCondition, o => o.MapFrom(c => c.HasAirCondition))
                .ForMember(c => c.HasAlarmSystem, o => o.MapFrom(c => c.HasAlarmSystem))
                .ForMember(c => c.HasAttic, o => o.MapFrom(c => c.HasAttic))
                .ForMember(c => c.HasBicycleRoom, o => o.MapFrom(c => c.HasBicycleRoom))
            ...
            cfg.CreateMap<Step9FlatForSale, FlatForSale>()
                .ForAllOtherMembers(c => c.Ignore());

            cfg.CreateMap<Step9HouseForRent, HouseForRent>()
                .ForMember(c => c.HasAirCondition, o => o.MapFrom(c => c.HasAirCondition))
                .ForMember(c => c.HasAlarmSystem, o => o.MapFrom(c => c.HasAlarmSystem))
                .ForMember(c => c.HasAttic, o => o.MapFrom(c => c.HasAttic))
                .ForMember(c => c.HasBicycleRoom, o => o.MapFrom(c => c.HasBicycleRoom))
            ...
            cfg.CreateMap<Step9HouseForSale, HouseForSale>()
                .ForMember(c => c.HasAirCondition, o => o.MapFrom(c => c.HasAirCondition))
                .ForMember(c => c.HasAlarmSystem, o => o.MapFrom(c => c.HasAlarmSystem))
                .ForMember(c => c.HasAttic, o => o.MapFrom(c => c.HasAttic))
                .ForMember(c => c.HasBicycleRoom, o => o.MapFrom(c => c.HasBicycleRoom))
            ...
            cfg.CreateMap<Step9LandForSale, LandForSale>()
                .ForAllOtherMembers(c => c.Ignore());
        }
    }
}