...
{
    public class SearchProfileToDto:IAutoMapperTypeConfigurator
    {
        public void Configure(IMapperConfigurationExpression cfg)
        {
            cfg.CreateMap<SearchProfileFlatForRent, DetailedSearchFlatForRent>()
               ...
               .ForMember(c => c.Name, o => o.MapFrom(c => c.Title))
               ...
               .ForMember(c => c.FeatureCategoryViewModels, o => o.MapFrom(c => c.SelectedFeatureCategories))
               .ForMember(c => c.FloorViewModels, o => o.MapFrom(c => c.SelectedFloors))
               .ForMember(c => c.HeatingTypeViewModels, o => o.MapFrom(c => c.SelectedHeatings))
               .ForMember(c => c.BeaconingTypeViewModels, o => o.MapFrom(c => c.SelectedBeaconings))
               .ForMember(c => c.ParkSpaceTypeViewModels, o => o.MapFrom(c => c.SelectedParkSpaces))
               .ForMember(c => c.AdjustmentBalconyTerrace, o => o.MapFrom(c => c.GeoDirection))
               .ForMember(c => c.SightTypeViewModels, o => o.MapFrom(c => c.SelectedSights))
               .ForAllOtherMembers(c => c.Ignore());

            cfg.CreateMap<SearchProfileFlatForSale, DetailedSearchFlatForSale>()
               .ForMember(c => c.BalconyTerraceArea, o => o.MapFrom(c => c.BalconyTerraceArea))
               .ForMember(c => c.GardenArea, o => o.MapFrom(c => c.GardenArea))
               .ForMember(c => c.HasAirCondition, o => o.MapFrom(c => c.HasAirCondition))
               .ForMember(c => c.HasApprovalOfAddress, o => o.MapFrom(c => c.HasApprovalOfAddress))
            ...
            cfg.CreateMap<SearchProfileHouseForRent, DetailedSearchHouseForRent>()
               .ForMember(c => c.BalconyTerraceArea, o => o.MapFrom(c => c.BalconyTerraceArea))
               .ForMember(c => c.GardenArea, o => o.MapFrom(c => c.GardenArea))
               .ForMember(c => c.HasAirCondition, o => o.MapFrom(c => c.HasAirCondition))
               .ForMember(c => c.HasApprovalOfAddress, o => o.MapFrom(c => c.HasApprovalOfAddress))
               ...
               .ForMember(c => c.AdjustmentBalconyTerrace, o => o.MapFrom(c => c.GeoDirection))
               .ForMember(c => c.SightTypeViewModels, o => o.MapFrom(c => c.SelectedSights))
               .ForMember(c => c.HouseTypeViewModels, o => o.MapFrom(c => c.SelectedHouseTypes))
               .ForMember(c => c.PlotArea, o => o.MapFrom(c => c.PlotArea))
               .ForAllOtherMembers(c => c.Ignore());

            cfg.CreateMap<SearchProfileHouseForSale, DetailedSearchHouseForSale>()
               .ForMember(c => c.BalconyTerraceArea, o => o.MapFrom(c => c.BalconyTerraceArea))
               .ForMember(c => c.GardenArea, o => o.MapFrom(c => c.GardenArea))
               .ForMember(c => c.HasAirCondition, o => o.MapFrom(c => c.HasAirCondition))
               .ForMember(c => c.HasApprovalOfAddress, o => o.MapFrom(c => c.HasApprovalOfAddress))
