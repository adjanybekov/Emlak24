...
namespace Wohnungstausch24.Models.ViewModels.Listings.Steps.Step7.Flat
{
    public class Step7FlatForRent:Step7Flat, IStep7FlatForRent
    {
        [Display(Name = "Is_Smoking_Allowed", ResourceType = typeof(Resource))]
        public bool IsSmokingAllowed { get; set; }

        [Display(Name = "Property_Add_PrefferedGender", ResourceType = typeof(Resource))]
        ...
        [Display(ResourceType = typeof(Resource), Name = "Property_Add_Income")]
