                  ...
                  <div role="menu" class="js-dropdown-menu navbar__dropdown navbar__dropdown--colls-2">
                    ...
                    <div class="navbar__submenu">
                      ...
                      <ul class="navbar__subnav">
                        ...
                        <li class="navbar__subitem active"><a href="properties_listing_list.html" class="navbar__sublink js-navbar-sublink">List</a></li>
            ...
            <div class="row">
              ...
              <div class="site site--main">
                ...
                <div class="site__panel">
                  ...
                  <div class="listing__view"><span class="control-label">View:</span><a href="properties_listing_grid.html" class="btn--white"><i class="fa fa-th-large"></i></a><a href="properties_listing_list.html" class="btn--white active"><i class="fa fa-bars"></i></a><a href="properties_listing_table.html" class="btn--white"><i class="fa fa-table"></i></a></div>
